...
function PipetteIcon({ color }: { color: string }) {
    const { React } = getGlobalApi();
    return React.createElement("svg", { width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: 2 },
        React.createElement("path", { d: "m2 22 1-1h3l9-9m0 0L9 6l6-6 6 6-6 6Z" })
    );
}
