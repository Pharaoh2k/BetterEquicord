 ...
 * - Added changelog.tsx (changelog modal implementation)
*/

// src/plugins/bdCompatLayer/ui/changelog.tsx
...
.bd-cl-card{pointer-events:auto;width:min(720px,calc(100vw - 24px));max-height:calc(100vh - 24px);background:var(--bd-cl-bg,#2b2d31);color:var(--bd-cl-fg,#f2f3f5);border-radius:8px;overflow:hidden;box-shadow:0 16px 40px rgba(0,0,0,.4),0 4px 12px rgba(0,0,0,.2);transform:translateY(8px) scale(.985);opacity:0;animation:bd-cl-pop .15s ease forwards}
